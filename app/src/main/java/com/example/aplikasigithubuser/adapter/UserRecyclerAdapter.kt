...
class UserRecyclerAdapter(private val users: ArrayList<User>,private val listener: (User) -> Unit) :RecyclerView.Adapter<UserRecyclerAdapter.ViewHolder>(){
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        fun bind(user: User) {
            ...
            txtGithub.text = user.repository
